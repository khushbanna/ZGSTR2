...
//  coalesce( cast(IGST_I.AmountInCompanyCodeCurrency as abap.dec( 20 , 2 ) ) , 0)                       as igst_amt, 
  ...
  case when IT.gstrate <> 0.00
  then IT.gstrate else  IT_I.gstrate  end                                                              as igst_rate,
  IT_I.gstrate                                                                                         as igst_rate_I,

  cast( 'ELG'  as abap.char(20)  )                                                                     as REPORT,
...
where
  (
    ...
    or A.AccountingDocumentType =    'DZ'
  ...
  and(
       ( B.TaxCode                like 'V%' and B.TaxCode           not like 'V0%' )
    or B.TaxCode                like 'I%'
  )
